---
 ...
 title: "Stellar Scaffold" parent: Public Good Projects proposal_issue: 62 proposer: chadoh category:
"Developer Experience" budget: "50000
--

#  Stellar Scaffol

_\_Go from idea to app faster with a custom, pluggable CLI; a multi-framework template system; and a
customizable, modern frontend_

|                       |                                            |
| --------------------- | ------------------------------------------ |
| **\*Categor**         |  Developer Experienc                       |
| **\*Websit**          |  <https://scaffoldstellar.org/             |
| **\*Repositor**       |  <https://github.com/stellar-scaffold/cli/ |
| **\*First Release**   |  May 202                                   |
| **\*Intak**           |  soft-launc                                |
| **\*Budget Requeste** |  5000                                      |
...
Stellar Scaffold is built and maintained by**\*The Aha Compan*** (formerly Aha Labs), a team of 10+
...
and identified**\*The Aha Compan*** as the team with the right combination of product mindset and
deep technical ability to “install the batteries.

##  Foundational Stellar developer workflows we designed and shippe
...
- **\*JavaScript developer experience patterns*** including the**\*Contract Clien*** behavior
  in**\*stellar-sdk-j***, which helps application developers interact with contracts more safely and
  predictably

##  Why we were selected for Stellar Scaffold and our SCF track recor
...
1. our deep**\*CLI & JS expertis*** proven through shipped core tooling, an
2. our track record delivering developer infrastructure via SCF, including
   - **\*Smart
     Deplo***: [https://communityfund.stellar.org/project/smart-deploy-yoj](https://communityfund.stellar.org/project/smart-deploy-yoj
   - **\*Loa***: [https://communityfund.stellar.org/project/loam-qj5](https://communityfund.stellar.org/project/loam-qj5
...
##  Ongoing maintenance and production-grade integration experienc

Since then, we have remained engaged with SDF to support and maintain key tooling (most recently
improving Stellar CLI handling of**\*hardware-based key***) and we continue to operate as an
integration partner on production deployments. Notably, we**\*architected and developed Société
Générale’s EURC*** on Stellar (now live), bringing a rigorous, real-world perspective to developer
tooling and reliability requirements

##  Deep community participation and ecosystem leadershi

Our team includes well-known ecosystem contributors. Several members hold key community roles
(e.g.,**\*SCF Pilo***,**\*category delegate***) and actively build their own SCF projects
(e.g.,**\*Moonlight, Tansu, Stellar Merch Store, PG Atla***). We contribute to protocol and tooling
...
Beyond Stellar, The Aha Company is also an integration partner in other ecosystems
(e.g.,**\*Filecoin, XRPL, Cardano, Canton, Starkne***). This gives us a unique ability to benchmark
developer experience across chains and bring proven patterns back to Stellar—while keeping Stellar
Scaffold aligned with what developers expect from modern, full-stack tooling
...
- **\*Continuous releases*** Three`stellar-scaffold-cli`` releases shipped this quarter (v0.0.22,
  v0.0.23, v0.0.24) plus supporting crates, with
  notes: https://github.com/stellar-scaffold/cli/release
- **\*Upstream documentation contribution***, e.g. improving prerequisites on the official Stellar
  docs (https://github.com/stellar/stellar-docs/pull/2267)
...
###  D1: Support Stellar-Wallets-Kit v
...
> - Measure: update shipped in fronten
> - Issue: https://github.com/stellar-scaffold/cli/issues/44

In progress: the upgrade PR is open and under review
at https://github.com/stellar-scaffold/ui/pull/241. The Template Monorepo restructure (see D3, D8)
moved wallet integration into the shared`@stellar-scaffold/app-lib`` package, so the v2 upgrade now
lands once for every framework template instead of once per template. Finishing this is committed in
Q3 (see Proposed D3)

###  D2: Allow package manager of choic
...
> - Measure: feature shipped, tested, & documente
> - Issue: https://github.com/stellar-scaffold/cli/issues/16

**\*Shipped*** Core package-manager-agnostic behavior merged
in
https://github.com/stellar-scaffold/cli/pull/345, with follow-up improvements
in
...
**\*Substantially shippe*** via the Template Monorepo effort
(https://github.com/stellar-scaffold/cli/pull/543
and https://github.com/stellar-scaffold/ui/pull/234)
...
- The single React frontend repo became a multi-framework template monorepo
  ...
  formatting logic), delivering the official**\*Svelte templat***
- `stellar scaffold init --template`` accepts either an official framework name (e.g.`svelte``) or
  an`org/repo`` community template, establishing the "bring your own frontend" path
...
###  D4: SKILL.md to help agentic workflow
...
> - Issue: https://github.com/stellar-scaffold/cli/issues/39
...
###  D5: Improve Scaffold info on main Stellar doc

> - Minimize the info on the Stellar Scaffold page on the main Stellar docs in line with other tools
>   that have their own documentations sites, linking prominently to https://scaffoldstellar.or
> - Measure: new documentation page shipped to main Stellar doc
> - Issue: https://github.com/stellar-scaffold/cli/issues/36
...
###  D6: Monitor releases of ecosystem project
...
> - Measure: system in place for notifying Scaffold team of ecosystem project update
> - Issue: https://github.com/stellar-scaffold/cli/issues/30
...
projects*\*built wit** Scaffold can inherit the same alerts. Our existing scheduled-update flow for
...
###  D7: Allow building for testnet when localnet unhealth
...
> - Measure: bug fix shippe
> - Issue: https://github.com/stellar-scaffold/cli/issues/26
...
###  D8: Re-architect stellar scaffold build internals & update to latest best practice
...
> - Issues: https://github.com/stellar-scaffold/cli/issues/329, https://github.com/stellar-scaffold/cli/issues/346, https://github.com/stellar-scaffold/cli/issues/18
...
###  Ongoing maintenance, releases, and field feedback loo
...
AI-assisted builders (the majority at recent hackathons) to produce working Stellar dApps.
And`scaffold doctor`` cuts the support burden that environment problems create at every hackathon
...
##  D1: Create`scaffold doctor`` comman
...
##  D2: Complete the`scaffold.yml`` configuration migratio

- Finish the CLI configuration rework begun in Q2: fold network and contract-client configuration
  into`scaffold.yml`` (whose`config:`` section shipped with the template monorepo),
  retire`environments.toml``, and pass through the`--optimize`` flag to`stellar contract build``
...
- Issues: https://github.com/stellar-scaffold/cli/issues/181, https://github.com/stellar-scaffold/cli/issues/32
...
##  D3: Ship Stellar-Wallets-Kit v2 through the shared wallet modul

- Land the in-review Wallets-Kit v2 upgrade in the shared`@stellar-scaffold/app-lib`` package so all
  framework templates (React, Svelte, and future Vue) get the upgrade from a single integration point
- Measure: upgrade merged and released across all official templates
- Issue: https://github.com/stellar-scaffold/cli/issues/441
  (implementation: https://github.com/stellar-scaffold/ui/pull/241
...
- Publish a self-contained`SKILL.md`` at scaffoldstellar.org teaching AI agents Scaffold as a system,
  ...
  end users get docs scoped to*\*thei** app)
...
##  D5: Complete BYOFrontend: "no frontend" option + community-template guid
...
- Finish the remaining scope from Q2's BYOFrontend deliverable: a "no frontend" init option
  ...
  members build and publish their own framework templates
  for`stellar scaffold init --template org/repo``
...
##  D6: Documentation consolidation & redesig
...
- Issues: https://github.com/stellar-scaffold/cli/issues/556, https://github.com/stellar-scaffold/cli/issues/437, https://github.com/stellar-scaffold/cli/issues/361, https://github.com/stellar-scaffold/cli/issues/55
...
##  D7: Ongoing maintenance & release
...
##  D8 (Stretch): Vue UI templat

- Add Vue as a third official frontend template in the template monorepo, selectable
  via`stellar scaffold init``
- Measure: template shipped with e2e coverage, selectable in`init``, documented
- Issue: https://github.com/stellar-scaffold/cli/issues/55
...
##  D9 (Stretch): Monitor releases of ecosystem project
...
##  D10 (Stretch): Anonymous usage telemetr
...
##  D11 (Stretch): Interactive OpenZeppelin contract wizar
...
- Measure: feature shipped, tested, and documented
- Issue: https://github.com/stellar-scaffold/cli/issues/15
- Ecosystem value: safe, audited building blocks become the path of least resistance for new
  contracts

##  D12 (Stretch): Update starter app's Debug pag
...
- Issue: https://github.com/stellar-scaffold/cli/issues/24
