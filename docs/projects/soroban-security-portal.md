...
1. **Dev Tools (soroban-ret integration)** — new Rust/Axum micro-service 
   ...
   This has been added as a bonus milestone to our [Soroban-Reverse-Engineering-Tool
   ](https://github.com/Inferara/soroban-ret). You can access it from the [Dev Tools
   ](https://stellarsecurityportal.com/dev-tools) button on the menu.
...
4. **Audit-report ingestion** — background worker fetches PDFs, extracts metadata and 
   ...
   compare them to the original report with manual edits. **We are not relying on AI to log 
   findings to the Portal!**
...
9. **Navigator Contributions** — We have enabled Navigators to participate in the Portal. You can 
   read more [On Medium
   ](https://medium.com/@inferara/how-the-soroban-security-portal-is-evolving-5a37cb674217) on 
   the changes.
