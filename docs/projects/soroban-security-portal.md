...
1. **Dev Tools (soroban-ret integration)** — new Rust/Axum micro-service (`DevTools/soroban-ret-web`)
   ...
   [Soroban-Reverse-Engineering-Tool ](https://github.com/Inferara/soroban-ret). You can access it
...
9. **Navigator Contributions** — We have enabled Navigators to participate in the Portal. You can
   read more
   [On Medium ](https://medium.com/@inferara/how-the-soroban-security-portal-is-evolving-5a37cb674217)
   on the changes.
