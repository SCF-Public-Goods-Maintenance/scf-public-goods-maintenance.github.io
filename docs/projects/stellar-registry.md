...
_Copy/update rest of bio from
[Q3 proposal](https://github.com/SCF-Public-Goods-Maintenance/scf-public-goods-maintenance.github.io/pull/117)_
...
- https://github.com/stellar-registry/cli/issues/50 (assigned to @chadoh, who would indeed like to
...
- We continue to participate in
  [ongoing RFP discussions](https://github.com/orgs/stellar/discussions/1945#discussioncomment-17897997).
...
- https://github.com/stellar-registry/oz-combined-wasms/issues/1 (@willemneal assigned; work to start
  Aug 17, ~1w effort???)
